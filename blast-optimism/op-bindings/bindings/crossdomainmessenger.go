...
func (_CrossDomainMessenger *CrossDomainMessengerCaller) DiscountedValues(opts *bind.CallOpts, arg0 [32]byte) (*big.Int, error) {
	var out []interface{}
	err := _CrossDomainMessenger.contract.Call(opts, &out, "discountedValues", arg0)
...
//
// Solidity: function discountedValues(bytes32 ) view returns(uint256)
func (_CrossDomainMessenger *CrossDomainMessengerSession) DiscountedValues(arg0 [32]byte) (*big.Int, error) {
	return _CrossDomainMessenger.Contract.DiscountedValues(&_CrossDomainMessenger.CallOpts, arg0)
}

// DiscountedValues is a free data retrieval call binding the contract method 0x9fa0bd8b.
//
// Solidity: function discountedValues(bytes32 ) view returns(uint256)
func (_CrossDomainMessenger *CrossDomainMessengerCallerSession) DiscountedValues(arg0 [32]byte) (*big.Int, error) {
	return _CrossDomainMessenger.Contract.DiscountedValues(&_CrossDomainMessenger.CallOpts, arg0)
}
