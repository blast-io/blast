...
func TestWithdrawals(t *testing.T) {
	...
	t.Skipf("TODO But back the right withdrawal hint ID")

	proveReceipt, finalizeReceipt, resolveClaimReceipt, resolveReceipt := ProveAndFinalizeWithdrawal(t, cfg, sys, "verifier", ethPrivKey, receipt, func() *big.Int {
		return common.Big0
	})
