...
contract L1CrossDomainMessenger is CrossDomainMessenger, ISemver {
    ...
    /// @notice Blast addition to record the withdrawal amount for
    ...
    /// Blast: This function is modified from CrossDomainMessenger
        ...
        override
    {
        ...
        if (_isOtherMessenger()) {
            // Blast: This check is modified to allow for discounted withdrawals.
            ...
            // Blast: Retrieve the potentially discounted value that was sent when the
        ...
        if (
            ...
            // Blast: Need to store the discounted value so it can be replayed with the correct value.
