...
func (n *OpNode) initL2(ctx context.Context, cfg *Config, snapshotLog log.Logger) error {
	...
	n.l2Driver = driver.NewDriver(&cfg.Driver, &cfg.Rollup, cfg.L1ChainConfig, n.l2Source, n.l1Source, n.beacon, n, n, n.log, snapshotLog, n.metrics, cfg.ConfigPersistence, &cfg.Sync)
