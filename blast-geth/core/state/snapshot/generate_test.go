...
func testGeneration(t *testing.T, scheme string) {
	...
	helper.addTrieAccount("acc-1", &types.StateAccount{Fixed: big.NewInt(1), Flags: 1, Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})
	helper.addTrieAccount("acc-2", &types.StateAccount{Fixed: big.NewInt(2), Flags: 1, Root: types.EmptyRootHash, CodeHash: types.EmptyCodeHash.Bytes()})
	helper.addTrieAccount("acc-3", &types.StateAccount{Fixed: big.NewInt(3), Flags: 1, Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})
	...
	if have, want := root, common.HexToHash("0x02e2517669a09aaac974f122d08c07e460466c042a847ab7d696718d47bbb7c5"); have != want {
...
func testGenerateExistentState(t *testing.T, scheme string) {
	...
	helper.addTrieAccount("acc-1", &types.StateAccount{Fixed: big.NewInt(1), Flags: 1, Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})
	helper.addSnapAccount("acc-1", &types.StateAccount{Fixed: big.NewInt(1), Flags: 1, Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})
	helper.addSnapStorage("acc-1", []string{"key-1", "key-2", "key-3"}, []string{"val-1", "val-2", "val-3"})

	helper.addTrieAccount("acc-2", &types.StateAccount{Fixed: big.NewInt(2), Flags: 1, Root: types.EmptyRootHash, CodeHash: types.EmptyCodeHash.Bytes()})
	helper.addSnapAccount("acc-2", &types.StateAccount{Fixed: big.NewInt(2), Flags: 1, Root: types.EmptyRootHash, CodeHash: types.EmptyCodeHash.Bytes()})

	stRoot = helper.makeStorageTrie(hashData([]byte("acc-3")), []string{"key-1", "key-2", "key-3"}, []string{"val-1", "val-2", "val-3"}, true)
	helper.addTrieAccount("acc-3", &types.StateAccount{Fixed: big.NewInt(3), Flags: 1, Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})
	helper.addSnapAccount("acc-3", &types.StateAccount{Fixed: big.NewInt(3), Flags: 1, Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})
...
func testGenerateExistentStateWithWrongStorage(t *testing.T, scheme string) {
	...
	helper.addAccount("acc-1", &types.StateAccount{Fixed: big.NewInt(1), Flags: 1, Root: types.EmptyRootHash, CodeHash: types.EmptyCodeHash.Bytes()})
	helper.addSnapStorage("acc-1", []string{"key-1", "key-2", "key-3"}, []string{"val-1", "val-2", "val-3"})

	// Account two, non empty root but empty database
	stRoot := helper.makeStorageTrie(hashData([]byte("acc-2")), []string{"key-1", "key-2", "key-3"}, []string{"val-1", "val-2", "val-3"}, true)
	helper.addAccount("acc-2", &types.StateAccount{Fixed: big.NewInt(1), Flags: 1, Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})

	// Miss slots
	{
		// Account three, non empty root but misses slots in the beginning
		helper.makeStorageTrie(hashData([]byte("acc-3")), []string{"key-1", "key-2", "key-3"}, []string{"val-1", "val-2", "val-3"}, true)
		helper.addAccount("acc-3", &types.StateAccount{Fixed: big.NewInt(1), Flags: 1, Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})
		...
		helper.addAccount("acc-4", &types.StateAccount{Fixed: big.NewInt(1), Flags: 1, Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})
		...
		helper.addAccount("acc-5", &types.StateAccount{Fixed: big.NewInt(1), Flags: 1, Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})
	...
	// Wrong storage slots
	{
		...
		helper.addAccount("acc-6", &types.StateAccount{Fixed: big.NewInt(1), Flags: 1, Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})
		...
		helper.addAccount("acc-7", &types.StateAccount{Fixed: big.NewInt(1), Flags: 1, Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})
		...
		helper.addAccount("acc-8", &types.StateAccount{Fixed: big.NewInt(1), Flags: 1, Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})
		...
		helper.addAccount("acc-9", &types.StateAccount{Fixed: big.NewInt(1), Flags: 1, Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})
	...
	// Extra storage slots
	{
		...
		helper.addAccount("acc-10", &types.StateAccount{Fixed: big.NewInt(1), Flags: 1, Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})
		...
		helper.addAccount("acc-11", &types.StateAccount{Fixed: big.NewInt(1), Flags: 1, Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})
		...
		helper.addAccount("acc-12", &types.StateAccount{Fixed: big.NewInt(1), Flags: 1, Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})
...
func testGenerateExistentStateWithWrongAccounts(t *testing.T, scheme string) {
	...
	{
		helper.addTrieAccount("acc-1", &types.StateAccount{Fixed: big.NewInt(1), Flags: 1, Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()}) // Beginning
		helper.addTrieAccount("acc-4", &types.StateAccount{Fixed: big.NewInt(1), Flags: 1, Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()}) // Middle
		helper.addTrieAccount("acc-6", &types.StateAccount{Fixed: big.NewInt(1), Flags: 1, Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()}) // End
	}

	// Wrong accounts
	{
		helper.addTrieAccount("acc-2", &types.StateAccount{Fixed: big.NewInt(1), Flags: 1, Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})
		helper.addSnapAccount("acc-2", &types.StateAccount{Fixed: big.NewInt(1), Flags: 1, Root: stRoot, CodeHash: common.Hex2Bytes("0x1234")})

		helper.addTrieAccount("acc-3", &types.StateAccount{Fixed: big.NewInt(1), Flags: 1, Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})
		helper.addSnapAccount("acc-3", &types.StateAccount{Fixed: big.NewInt(1), Flags: 1, Root: types.EmptyRootHash, CodeHash: types.EmptyCodeHash.Bytes()})
	}

	// Extra accounts, only in the snap
	{
		helper.addSnapAccount("acc-0", &types.StateAccount{Fixed: big.NewInt(1), Flags: 1, Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})              // before the beginning
		helper.addSnapAccount("acc-5", &types.StateAccount{Fixed: big.NewInt(1), Flags: 1, Root: types.EmptyRootHash, CodeHash: common.Hex2Bytes("0x1234")})  // Middle
		helper.addSnapAccount("acc-7", &types.StateAccount{Fixed: big.NewInt(1), Flags: 1, Root: types.EmptyRootHash, CodeHash: types.EmptyCodeHash.Bytes()}) // after the end
	}
...
func TestGenerateCorruptAccountTrie(t *testing.T) {
	// NOTE: these tests hardcode hashes that are StateAccount depending
	// Blast's changes to the state trie require recomputing the correct hashes for this test case
...
func testGenerateCorruptAccountTrie(t *testing.T, scheme string) {
	...
	helper.addTrieAccount("acc-1", &types.StateAccount{Fixed: big.NewInt(1), Flags: 1, Root: types.EmptyRootHash, CodeHash: types.EmptyCodeHash.Bytes()}) // 0xc7a30f39aff471c95d8a837497ad0e49b65be475cc0953540f80cfcdbdcd9074
	helper.addTrieAccount("acc-2", &types.StateAccount{Fixed: big.NewInt(2), Flags: 1, Root: types.EmptyRootHash, CodeHash: types.EmptyCodeHash.Bytes()}) // 0x65145f923027566669a1ae5ccac66f945b55ff6eaeb17d2ea8e048b7d381f2d7
	helper.addTrieAccount("acc-3", &types.StateAccount{Fixed: big.NewInt(3), Flags: 1, Root: types.EmptyRootHash, CodeHash: types.EmptyCodeHash.Bytes()}) // 0x19ead688e907b0fab07176120dceec244a72aff2f0aa51e8b827584e378772f4
...
func testGenerateMissingStorageTrie(t *testing.T, scheme string) {
	...
	helper.addTrieAccount("acc-1", &types.StateAccount{Fixed: big.NewInt(1), Flags: 1, Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})              // 0x9250573b9c18c664139f3b6a7a8081b7d8f8916a8fcc5d94feec6c29f5fd4e9e
	helper.addTrieAccount("acc-2", &types.StateAccount{Fixed: big.NewInt(2), Flags: 1, Root: types.EmptyRootHash, CodeHash: types.EmptyCodeHash.Bytes()}) // 0x65145f923027566669a1ae5ccac66f945b55ff6eaeb17d2ea8e048b7d381f2d7
	stRoot = helper.makeStorageTrie(hashData([]byte("acc-3")), []string{"key-1", "key-2", "key-3"}, []string{"val-1", "val-2", "val-3"}, true)
	helper.addTrieAccount("acc-3", &types.StateAccount{Fixed: big.NewInt(3), Flags: 1, Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()}) // 0x50815097425d000edfc8b3a4a13e175fc2bdcfee8bdfbf2d1ff61041d3c235b2
...
func testGenerateWithExtraAccounts(t *testing.T, scheme string) {
	helper := newHelper(scheme)
	{
		...
		acc := &types.StateAccount{Fixed: big.NewInt(1), Flags: 1, Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()}
		val, _ := rlp.EncodeToBytes(acc)
...
func testGenerateWithManyExtraAccounts(t *testing.T, scheme string) {
	...
	}
	{
		...
		for i := 0; i < 1000; i++ {
			acc := &types.StateAccount{Fixed: big.NewInt(int64(i)), Flags: 1, Root: types.EmptyRootHash, CodeHash: types.EmptyCodeHash.Bytes()}
			val, _ := rlp.EncodeToBytes(acc)
...
func testGenerateWithExtraBeforeAndAfter(t *testing.T, scheme string) {
	...
	helper := newHelper(scheme)
	{
		acc := &types.StateAccount{Fixed: big.NewInt(1), Flags: 1, Root: types.EmptyRootHash, CodeHash: types.EmptyCodeHash.Bytes()}
		val, _ := rlp.EncodeToBytes(acc)
...
func testGenerateFromEmptySnap(t *testing.T, scheme string) {
	...
	for i := 0; i < 400; i++ {
		...
		helper.addTrieAccount(fmt.Sprintf("acc-%d", i),
			&types.StateAccount{Fixed: big.NewInt(1), Flags: 1, Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})
	}
	root, snap := helper.CommitAndGenerate()
...
func testGenerateWithIncompleteStorage(t *testing.T, scheme string) {
	...
	for i := 0; i < 8; i++ {
		...
		helper.addAccount(accKey, &types.StateAccount{Fixed: big.NewInt(int64(i)), Flags: 1, Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})
...
func testGenerateCompleteSnapshotWithDanglingStorage(t *testing.T, scheme string) {
	...
	stRoot := helper.makeStorageTrie(hashData([]byte("acc-1")), []string{"key-1", "key-2", "key-3"}, []string{"val-1", "val-2", "val-3"}, true)
	helper.addAccount("acc-1", &types.StateAccount{Fixed: big.NewInt(1), Flags: 1, Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})
	helper.addAccount("acc-2", &types.StateAccount{Fixed: big.NewInt(1), Flags: 1, Root: types.EmptyRootHash, CodeHash: types.EmptyCodeHash.Bytes()})
