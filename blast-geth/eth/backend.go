...
func New(stack *node.Node, config *ethconfig.Config) (*Ethereum, error) {
	...
	chainDb, err := stack.OpenDatabaseWithFreezer("chaindata", config.DatabaseCache, config.DatabaseHandles, config.DatabaseFreezer, "eth/db/chaindata/", false, config.PebbleFormatVersion)
	if err != nil {
		return nil, err
	}
